# :pushpin: Bastion Host
:open_file_folder: **Document Version 1.0**

This Azure Release Pipeline is using Terraform to create **Bastion Host**
...
| ---- | ---- |
| :white_check_mark: bastion_creation.tf | Terraform |
| :white_check_mark: bastion_variables.tf | Terraform |
| :white_check_mark: bastion_input_variables.ps1 | PowerShell |
...
1. This script required ImportExcel PowerShell module to capture excel file "Bastion" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "Bastion" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>bastion.tfstate</td>
  </tr>
  <tr>
    <th><b>Configuration Directory</b></th>
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/bastion</td>
  </tr>
</table>
