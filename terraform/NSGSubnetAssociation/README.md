# :pushpin: NSG-Subnet Association 
:open_file_folder: **Document Version 1.0**

This Azure Release Pipeline is using Terraform to link **NSG Subnet Association**
...
| ---- | ---- |
| :white_check_mark: NSG-Subnet-Association_creation.tf | Terraform |
| :white_check_mark: NSG-Subnet-Association_variables.tf | Terraform |
| :white_check_mark: NSG-Subnet-Association_input_variables.ps1 | PowerShell |
...
**PowerShell Script** - NSG-Subnet-Association_input_variables.ps1

1. This script required ImportExcel PowerShell module to capture excel file "NSG-Subnet-Association" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "NSGSubnetAssociation" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>nsg-subnet-association.tfstate</td>
  </tr>
  <tr>
    <th><b>Configuration Directory</b></th>
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/NSGSubnetAssociation</td>
  </tr>
</table>
