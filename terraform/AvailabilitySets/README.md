# :pushpin: Availability Sets
:open_file_folder: **Document Version 1.0**

This Azure Release Pipeline is using Terraform to create **Availability Sets**
...
| ---- | ---- |
| :white_check_mark: availability_sets_creation.tf | Terraform |
| :white_check_mark: availability_sets_variables.tf | Terraform |
| :white_check_mark: availability_sets_input_variables.ps1 | PowerShell |
...
**PowerShell Script** - availability_sets_input_variables.ps1

1. This script required ImportExcel PowerShell module to capture excel file "AvailabilitySets" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "AvailabilitySets" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>availability-sets.tfstate</td>
  </tr>
  <tr>
    <th><b>Configuration Directory</b></th>
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/AvailabilitySets</td>
  </tr>
</table>
