# :pushpin: Azure Log Analytics Workspace
:open_file_folder: **Document Version 1.0**

This Azure Release Pipeline is using Terraform to create **Azure Log Analytics**
...
| ---- | ---- |
| :white_check_mark: log_analytics_creation.tf | Terraform |
| :white_check_mark: log_analytics_variables.tf | Terraform |
| :white_check_mark: log_analytics_input_variables.ps1 | PowerShell |
...
**PowerShell Script** - log_analytics_input_variables.ps1

1. This script required ImportExcel PowerShell module to capture excel file "LogAnalytics" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "LogAnalytics" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>log-analytics.tfstate</td>
  </tr>
  <tr>
    <th><b>Configuration Directory</b></th>
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/LogAnalytics</td>
  </tr>
</table>
