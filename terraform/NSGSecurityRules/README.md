# :pushpin: Azure NSG Security Rules 
:open_file_folder: **Document Version 1.0**

This Azure Release Pipeline is using Terraform to create **Azure NSG Security Rules**
...
| ---- | ---- |
| :white_check_mark: security_rules_creation.tf | Terraform |
| :white_check_mark: security_rules_variables.tf | Terraform |
| :white_check_mark: security_rules_input_variables.ps1 | PowerShell |
...
**PowerShell Script** - security_rules_input_variables.ps1

1. This script required ImportExcel PowerShell module to capture excel file "NSGSecurityRules" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "NSGSecurityRules" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>NSGSecurityRules.tfstate</td>
  </tr>
  <tr>
    <th><b>Configuration Directory</b></th>
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/NSGSecurityRules</td>
  </tr>
</table>
