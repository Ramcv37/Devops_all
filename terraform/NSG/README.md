# :pushpin: Azure Network Security Group
:open_file_folder: **Document Version 1.0**

This Azure Release Pipeline is using Terraform to create **Azure Network Security Group**
...
| ---- | ---- |
| :white_check_mark: nsg_creation.tf | Terraform |
| :white_check_mark: nsg_variables.tf | Terraform |
| :white_check_mark: nsg_input_variables.ps1 | PowerShell |
...
**PowerShell Script** - nsg_input_variables.ps1

1. This script required ImportExcel PowerShell module to capture excel file "NSG" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "NSG" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/NSG</td>
  </tr>
</table>
