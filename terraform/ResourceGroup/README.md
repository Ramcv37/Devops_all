# :pushpin: Azure Resource Group
:open_file_folder: **Document Version 1.0**  

This Azure Release Pipeline is using Terraform to create **Azure Resource Group**
...
| ---- | ---- |
| :white_check_mark: resource_group_creation.tf | Terraform |
| :white_check_mark: resource_group_variables.tf | Terraform |
| :white_check_mark: resource_group_input_variables.ps1 | PowerShell |
...
**PowerShell Script** - resource_group_input_variables.ps1

1. This script required ImportExcel PowerShell module to capture excel file "ResourceGroup" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "ResourceGroup" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>resource_group.tfstate</td>
  </tr>
  <tr>
    <th><b>Configuration Directory</b></th>
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/ResourceGroup</td>
  </tr>
</table>
