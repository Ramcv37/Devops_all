# :pushpin: Network Interface
:open_file_folder: **Document Version 1.0**

This Azure Release Pipeline is using Terraform to create **Network Interface**
...
| ---- | ---- |
| :white_check_mark: network_interface_creation.tf | Terraform |
| :white_check_mark: network_interface_variables.tf | Terraform |
| :white_check_mark: network_interface_input_variables.ps1 | PowerShell |
...
**PowerShell Script** - network_interface_input_variables.ps1

1. This script required ImportExcel PowerShell module to capture excel file "NetworkInterfaces" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "NetworkInterfaces" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>network-interface.tfstate</td>
  </tr>
  <tr>
    <th><b>Configuration Directory</b></th>
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/NetworkInterfaces</td>
  </tr>
</table>
