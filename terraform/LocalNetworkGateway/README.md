# :pushpin: Azure Local Network Gateway 
:open_file_folder: **Document Version 1.0**

This Azure Release Pipeline is using Terraform to create **Azure Local Network Gateway**
...
| ---- | ---- |
| :white_check_mark: local_network_gateway_creation.tf | Terraform |
| :white_check_mark: local_network_gateway_variables.tf | Terraform |
| :white_check_mark: local_network_gateway_input_variables.ps1 | PowerShell |
...
**PowerShell Script** - local_network_gateway_input_variables.ps1

1. This script required ImportExcel PowerShell module to capture excel file "LocalNetworkGateway" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "LocalNetworkGateway" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>local_network_gateway.tfstate</td>
  </tr>
  <tr>
    <th><b>Configuration Directory</b></th>
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/LocalNetworkGateway</td>
  </tr>
</table>
