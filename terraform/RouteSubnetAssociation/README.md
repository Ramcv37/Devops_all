# :pushpin: Route Subnet Association
:open_file_folder: **Document Version 1.0**

This Azure Release Pipeline is using Terraform to create **Route Subnet Association**
...
| ---- | ---- |
| :white_check_mark: route_table_subnet_association_creation.tf | Terraform |
| :white_check_mark: route_table_subnet_association_variables.tf | Terraform |
| :white_check_mark: route_table_subnet_Association_input_variables.ps1 | PowerShell |
...
**PowerShell Script** - route_table_subnet_Association_input_variables.ps1

1. This script required ImportExcel PowerShell module to capture excel file "Route-Subnet-Association" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "RouteSubnetAssociation" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>route-subnet-association.tfstate</td>
  </tr>
  <tr>
    <th><b>Configuration Directory</b></th>
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/RouteSubnetAssociation</td>
  </tr>
</table>
