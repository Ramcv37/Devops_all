# :pushpin: Virtual Machines
:open_file_folder: **Document Version 1.0**

This Azure Release Pipeline is using Terraform to create **Virtual Machines**
...
| ---- | ---- |
| :white_check_mark: virtual_machines_creation.tf | Terraform |
| :white_check_mark: virtual_machines_variables.tf | Terraform |
| :white_check_mark: virtual_machines_input_variables.ps1 | PowerShell |
...
**PowerShell Script** - virtual_machines_input_variables.ps1

1. This script required ImportExcel PowerShell module to capture excel file "VirtualMachines" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "VirtualMachines" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>virtual-machines.tfstate</td>
  </tr>
  <tr>
    <th><b>Configuration Directory</b></th>
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/VirtualMachines</td>
  </tr>
</table>
