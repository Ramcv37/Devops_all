...
This Azure Release Pipeline is using Terraform to create **Route Tables**
...
| ---- | ---- |
| :white_check_mark: route_table_creation.tf | Terraform |
| :white_check_mark: route_table_variables.tf | Terraform |
| :white_check_mark: route_table_input_variables.ps1 | PowerShell |
...
**PowerShell Script** - route_table_input_variables.ps1

1. This script required ImportExcel PowerShell module to capture excel file "RouteTable" worksheet data.
2. Script will convert worksheet data to Terraform.tfvars file.
3. It will save terraform.tfvars file in "RouteTable" configuration directory
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>route-table.tfstate</td>
  </tr>
  <tr>
    <th><b>Configuration Directory</b></th>
    <td>$(System.DefaultWorkingDirectory)/_Terraform-OneClick/RouteTable</td>
  </tr>
</table>
